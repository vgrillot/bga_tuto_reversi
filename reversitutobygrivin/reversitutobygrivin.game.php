...
class ReversiTutoByGrivin extends Table
{
...
//////////// 
    ...
    /*
        ...
        (note: each method below must match an input method in reversitutobygrivin.action.php)
    */
